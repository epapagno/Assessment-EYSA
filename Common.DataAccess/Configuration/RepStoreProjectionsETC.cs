...
{
    public class RepStoreProjectionsETC : IEntityTypeConfiguration<RepStoreProjections>
    {
        public void Configure(EntityTypeBuilder<RepStoreProjections> builder)
        {
            // Generación tabla: REP_STORE_PROJECTIONS
            builder.ToTable("REP_STORE_PROJECTIONS", "REP").HasKey(i => new { i.Id, i.PaisId, i.TypeOfProjection, i.SeqId });
            ...
            builder.HasOne(i => i.RepStores).WithOne(i => i.RepStoreProjections)
                .HasForeignKey<RepStores>(i => new { i.Id, i.PaisId })
                .HasPrincipalKey<RepStoreProjections>(i => new { i.Id, i.PaisId });
        }
    }
}
